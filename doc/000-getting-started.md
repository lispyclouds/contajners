...
```clojure
{org.clojars.lispyclouds/contajners {:mvn/version "1.0.9"}}
```
...
#### Leiningen/Boot
```clojure
[org.clojars.lispyclouds/contajners "1.0.9"]
```

#### Gradle
```groovy
implementation "org.clojars.lispyclouds/contajners:1.0.9"
```
...
; From maven
(deps/add-deps '{:deps {org.clojars.lispyclouds/contajners {:mvn/version "1.0.9"}}})
...
```clojure
; Maven
{:deps {org.clojars.lispyclouds/contajners {:mvn/version "1.0.9"}}}
